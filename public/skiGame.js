...
function loadImages() {
    ...
    backgroundImg.src = './images/background.png'; // Your background image

    skierImg = new Image();
    skierImg.src = './images/skier.png'; // Your skier image

    rockImg = new Image();
    rockImg.src = './images/rock.png'; // Your rock image
}
