...
// Create music manager and leaderboard manager instance
...
function updateGame() {
    ...
    for (let i = 0; i < rocks.length; i++) {
        if (
            ...
            const position = leaderboardManager.addScore(score);
            ...
            console.log('Game ended, incrementing counter...');
            
            // Call incrementCounter without await
            gameCounter.incrementCounter().catch(error => {
